...
//import com.ch.listeners.*;
//import ReportUtil;
//import ReportUtil-1.0.0.class;
//import CH.Listeners.CH_TestReporter;
...
public class TestReporter implements IReporter {
	...
	// Main function to call the function for report header, Summary, Footer,
	// Archive and send email functions
	public void generateReport(List<XmlSuite> xml, List<ISuite> suites, String outdir) {
		ReporterLib Lib = new ReporterLib();
		strResultFile = "Test_Automation-TestReport.html";
		// CH_TestReporter Lib1 = new CH_TestReporter();
		try {
		...
		// strPOMFile = Property_Lib.getPropertyValue(CONFIG_PATH + CONFIG_FILE,
		// "POMFILE");
		/*
		 * strPOMFile = "./POM.xml"; try { strToEmail =
		 * ReporterLib.GetEnvironmentVariable(strPOMFile, "Test.EmailIDs"); } catch
		 * (Exception e) { e.printStackTrace(); } if(strToEmail!="" &&
		 * strNewResultFile!=""){ try { Lib.sendMail(strNewResultFile, strToEmail); }
